...
1. 读 `.cursor/skills/pomelosuki/SKILL.md`（通用设计方法）
2. 读**项目约束档案** `docs/pomelosuki/project-profile.md`（框架、shadcn 变体、路径、主题、命令）——若缺失，先按 SKILL 模板补齐再动手
3. 按需引用 `.cursor/skills/pomelosuki/references/design-principles.md` 相关章节
