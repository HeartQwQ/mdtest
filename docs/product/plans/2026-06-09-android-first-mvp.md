...
- Modify `docs/product/requirements.md`: keep Android screen control in first-stage acceptance criteria.
- Modify `docs/design/pomelosuki/project-profile.md`: keep the middle workspace as Android screen control plus file workspace.
- Modify `docs/design/pomelosuki/ui-v2-design-notes.md`: keep UI layout aligned with Android-first workflow.
- Modify `Agent/rules/AGENTS.md`: force future AI workers to keep screen mirroring in the product core.
